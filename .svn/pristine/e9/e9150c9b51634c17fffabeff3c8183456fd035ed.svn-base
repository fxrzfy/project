...
var myChart = echarts.init($("#newbar")[0], "shine"); //初始化地图 
option = {
  /*title : {
      text: '服务效率',
			x: 'center',
...
var myChart2 = echarts.init($("#newpie")[0], "shine"); //初始化地图 
option2 = {
  title : {
      text: '分期区域占比',
			x: 'right',
...
getByStype('1');
$('select[name=newCardTime]').change(function(){
    var value=$(this).val();
    getByStype(value);
});
