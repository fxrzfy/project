...
public class TwoDimensionCode {
	...
	public static void main(String[] args) {
		String imgPath = "/Users/anson/develop/test/a.png";
		/*String encoderContent = "Hello 大大、小小,welcome to QRCode!"
				+ "\nMyblog [ http://sjsky.iteye.com ]"
				+ "\nEMail [ sjsky007@gmail.com ]";*/
        String encoderContent = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=" + "1234567890123" + "&redirect_uri=" + "http%3A%2F%2Fwww.showtao.com.cn%2Fst-erp%2Findex.html%3ForderId%3D" + "&response_type=code&scope=snsapi_base&state=STATE&connect_redirect=1#wechat_redirect";
