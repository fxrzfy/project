...
public class AppUtil  {
	...
	public static ResultDto  returnSuccess(Object e){
		return new ResultDto<>(10000,"",e);
	}
	public static ResultDto  returnSuccess(){
		return new ResultDto<>(10000,"",null);
	}
	public static ResultDto  returnFail(String msg){
		return new ResultDto<>(20000,msg,null);
	}

	public static ResultDto returnObj(String msg,Integer code,Object data){
		return new ResultDto<>(code,msg,data);
	}

	public static ResultDto  returnAppSuccess(Object e){
		return new ResultDto<>(10000,"",e);
	}
	public static ResultDto  returnAppFail(Object e){
		return new ResultDto<>(20000,"",e);
	}
