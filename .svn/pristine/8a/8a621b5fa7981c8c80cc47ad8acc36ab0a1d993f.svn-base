function NavToggle() {
    ...
    $(".dislpayArrow").toggleClass("hiddenArrow"); 
    $(".dislpayArrow a").toggleClass("open");
}
...
layer.config({
    ...
    }), $(".full-height-scroll").slimScroll({ height: "100%" }), $("body").on("click", "#side-menu>li", function () {
        $("body").hasClass("mini-navbar") && NavToggle()
    }), $("body").on("click", "#side-menu>li li a", function () {
    ...
    if (localStorageSupport) {
        var a = localStorage.getItem("collapse_menu"), e = localStorage.getItem("fixednavbar"),
            i = localStorage.getItem("boxedlayout"), l = $("body");
