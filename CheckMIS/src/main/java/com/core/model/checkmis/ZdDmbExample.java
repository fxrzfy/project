...
public class ZdDmbExample extends PageHelper {
    /**
     * 数据库:CHECKMIS.ST_ZD_DMB
     *
     * @mbg.generated
     */
     ...
     * This class corresponds to the database table CHECKMIS.ST_ZD_DMB
     *
     * @mbg.generated
     */
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andDeptIdEqualTo(Long deptId,Long type){
            addCriterion("  EXISTS(SELECT 1 FROM ST_ZZDW_ZD_MAP WHERE ZD_ID=ID AND   DEPT_ID="+deptId+" AND TYPE ="+type+")");
            return (Criteria) this;
        }
        public Criteria andTypeEqualTo(String type){
            addCriterion("  EXISTS(SELECT 1 FROM ST_ZZDW_ZD_MAP WHERE ZD_ID=ID AND TYPE IN ("+type+"))");
            return (Criteria) this;
        }
    }
