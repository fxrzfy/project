var option_1, fullDay, _fullDay, args = comn.getArgs(), moduleType,t;
...
$(function() {
  ...
  if(moduleType == 2){
    chart.on("click", function(data) { 
      ...
      if (t=='mobile') {
        return;
        window.location.href="ranking.html?moduleType=2&reportType=3&timelineBankPay=" + _fullDay + "&uId="+uId + "&t="+t
      }else{
        return comn.addTab({
          title: "业务组银行放款排名",
          href: "./Modal/main/index/ranking.html?moduleType=2&reportType=3&timelineBankPay=" + _fullDay + "&uId="+uId + "&t="+t
        });
      }
    });
    ...
    chart.on("click",function(data){
      ...
      if (t=='mobile') {
        return;
        window.location.href="branchRanking.html?moduleType=3&reportType=3&timelineBankPay=" + _fullDay + "&uId="+uId + "&t="+t
      }else{
        return comn.addTab({
          title: "分公司银行放款排名",
          href: "./Modal/main/index/branchRanking.html?moduleType=3&reportType=3&timelineBankPay=" + _fullDay + "&uId="+uId + "&t="+t
        });
      }
    })
  }
  ...
  $('#fullScreen').click(function(){
    ...
    window.open ('bankPay.html'+str+'&type=fullScreen','bankPayFull','height='+height+',width='+width+',top=0,left=0,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no');
  });
