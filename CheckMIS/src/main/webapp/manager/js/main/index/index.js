...
// };
//
// function callOrderReceiveApply(){
// 	window.parent.menuItemClick.call({title:'停止接单申请', href:'./Modal/orderReceiveManage/stopOrderReceiveApply.html'});
// }
//
// $(function () {
//
...
//     	    		if(user.orderReveiveStatus != "" && user.orderReveiveStatus != undefined && user.orderReveiveStatus != null){
//     	        		document.getElementById("mainSpanId").innerHTML = "<a onClick='callOrderReceiveApply()'>当前登录账号有"+user.orderReveiveStatusName+"节点处于停止接单状态，订单将不会指派给您，如需恢复请至接单管理-停止接单申请菜单下进行设置。</a>";
//     	        	}
//     	    	}
//     	    }
//     	});
